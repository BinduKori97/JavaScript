...
class Google
{
constructor(birthday, gender, mobile)
{
...
class Movie {
constructor(movie_name, Number_of_tickets)
{
this.Theatre_name = "PSS multiplex"
this.Screen =" screen 3 "
this.movie_name = movie_name
this.movie_certification = "U"
this.class = "first "
this.price_per_ticket = "Rs.1050.00 "
...
this.class, this.price_per_ticket, this.Number_of_tickets , this.seat_numbers, this.Total_amount )
}
}
let Film = new Movie("JVT", 5)
Film.display()
